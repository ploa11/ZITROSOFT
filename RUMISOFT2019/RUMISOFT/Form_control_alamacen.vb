Public Class Form_control_alamacen
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        Form_Nvo_Ingreso.GroupBox1.Visible = False
        Form_Nvo_Ingreso.GroupBox2.Visible = False
    ...
    Private Sub mostrar()
        Try
            If ComboBox1.Text = SEDE Then
                ...
                MessageBox.Show("USTED ESTA AUTORIZADO PARA EL ALMACEN " & ComboBox1.Text & "", "ZITRO")
            Else
                MessageBox.Show("USTED NO ESTA AUTORIZADO PARA EL ALMACEN " & ComboBox1.Text & "", "ZITRO")
                Label2.Visible = False
                dgv.Visible = False
                TextBox1.Visible = False
    ...
    Private Sub NUEVO_REGISTRO()
        Try
            If cargo = MICARGO Then
                MessageBox.Show("USTED ESTA AUTORIZADO PARA INGRESO Y ACTUALIZACIONES EN EL ALMACEN DE " & ComboBox1.Text & "", "ZITRO")
            ...
            Else
                MessageBox.Show("USTED NO ESTA AUTORIZADO PARA INGRESO Y ACTUALIZACIONES EN ESTE ALMACEN " & ComboBox1.Text & "", "ZITRO")
            End If
        Catch ex As Exception
