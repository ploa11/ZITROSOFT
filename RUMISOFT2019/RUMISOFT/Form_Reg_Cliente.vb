        ...
        Try
            Select Case pase1
                Case "centro costo"
                    ...
                    dr = com.ExecuteReader
                    If dr.Read Then
                        Form_Reg_Cent_Costo.TextBox2.Text = dr(0)
                        Form_Reg_Cent_Costo.cod_clie = dr(0)
                        Form_Reg_Cent_Costo.TextBox5.Text = dr(1)
                    End If
                    dr.Close()
                    Form_Reg_SRV_SQL.conexion.Close()
                    Me.Close()
                Case "coti"
                    ...
                    dr = com.ExecuteReader
                    If dr.Read Then
                        Form_Cotizacion.TextBox2.Text = dr(0)
                        Form_Cotizacion.COD_CLIENTE = dr(0)
                        Form_Cotizacion.TextBox2.Text = dr(2)
                        Form_Cotizacion.TextBox3.Text = dr(1)
                        Form_Cotizacion.TextBox4.Text = dr(3)
                    End If
                    dr.Close()
                    Form_Reg_SRV_SQL.conexion.Close()
                    Me.Close()
