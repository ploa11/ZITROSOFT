Public Class Form_Contacto_Proveedor
    ...
    'variables publicas
    Public pase1, pase2, codigo, pase3, pase4, cod_clie, cod_sede, codbanccontac, RUC As String
            ...
            For o = 0 To ListView1.Items.Count - 1
                If accion = "guardar" Then
                    ...
                    Else
                        ...
                        'Dim ape As String = ListView1.Items(0).SubItems(2).Text
                        'Dim emp As String = ListView1.Items(0).SubItems(3).Text
                        ' Dim dni As String = ListView1.Items(0).SubItems(4).Text
                        ' Dim fec As String = DateTimePicker1.Value.ToString("yyyyMMdd")
                        'Dim mail As String = ListView1.Items(0).SubItems(6).Text
                        ' sql = "INSERT INTO T_PROVEEDOR_CONTACTO VALUES ( '" & codigo & "','" & UCase(ListView1.Items(o).SubItems(1).Text) & "','" & UCase(ListView1.Items(o).SubItems(2).Text) & "','" & UCase(ListView1.Items(o).SubItems(3).Text) & "','" & DateTimePicker1.Value.ToString("yyyy-MM-dd") & "','" & UCase(ListView1.Items(o).SubItems(5).Text) & "','" & UCase(ListView1.Items(o).SubItems(4).Text) & "')"
                        sql = "insert into T_PROVEEDOR_CONTACTO values('" & codigo & "','" & UCase(ListView1.Items(o).SubItems(1).Text) & "','" & UCase(ListView1.Items(o).SubItems(2).Text) & "','" & UCase(ListView1.Items(o).SubItems(3).Text) & "','" & UCase(ListView1.Items(o).SubItems(5).Text) & "','" & DateTimePicker1.Value.ToString("yyyyMMdd") & "','" & UCase(ListView1.Items(o).SubItems(4).Text) & "')"
                        Form_Reg_SRV_SQL.conectar()
                        com = New SqlClient.SqlCommand(sql, Form_Reg_SRV_SQL.conexion)
            ...
            Select Case pase1
                Case "oc"
                    ...
                    If dr.Read Then
                        ...
                        Form_Orden_Compra.TextBox10.Text = dr(6)
                    End If
                    dr.Close()
                    Form_Reg_SRV_SQL.conexion.Close()
                    Me.Close()
                ...
                Case "COTI"
                    ...
                    dr = com.ExecuteReader
                    If dr.Read Then
                        Form_Cotizacion.TextBox1.Text = dr(1)
                        Form_Cotizacion.TextBox9.Text = dr(2)
                        Form_Cotizacion.TextBox10.Text = dr(6)
                        'Form_Cotizacion.TextBox5.Text = dr(6)
