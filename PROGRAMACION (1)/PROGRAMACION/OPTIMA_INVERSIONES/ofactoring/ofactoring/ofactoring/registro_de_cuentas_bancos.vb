Public Class registro_de_cuentas_bancos
    ...
    Private Sub Button12_Click(sender As Object, e As EventArgs) Handles Button12.Click
        ...
        t8.Text = Regristro_mancomunado.n_manc
        nom_manc = t8.Text
    ...
    Private Sub registro_de_cuentas_bancos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Text = "Registro de Cuentas Bancarias de Fondo" & " | " & Datos_Generales_del_Fondo.t2.Text & " | " & Datos_Generales_del_Fondo.t1.Text
