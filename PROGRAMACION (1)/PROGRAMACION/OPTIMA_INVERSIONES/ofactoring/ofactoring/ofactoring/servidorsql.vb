Public Class servidorsql
    ...
    Dim res As Integer, nomserv, ususql, clavesql, bdp As String
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        If accion = "guardar" Then
            ...
            If dr.Read Then
                ...
                conexion.Close()
            Else
                sql = "exec alta_servsql '" + nomserv + "','" + ususql + "','" + clavesql + "','" + bdp + "'"
                conexion.conectar()
                com = New SqlClient.SqlCommand(sql, conexion.conexion)
        ...
        ElseIf accion = "editar" Then
            sql = "exec edita_servsql'" + nc + "','" + nomserv + "','" + ususql + "','" + clavesql + "','" + bdp + "'"
            conexion.conectar()
            com = New SqlClient.SqlCommand(sql, conexion.conexion)
            res = com.ExecuteNonQuery
            conexion.Close()
    ...
    Private Sub dgv_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgv.CellContentClick
        ...
        Else
            MessageBox.Show("El nombre de servidor sql no Existe", "Optima")
        End If
        dr.Close()
        conexion.Close()
    End Sub
    ...
    Private Sub servidorsql_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Me.Text = "Configuracion de Servidor de Base de Datos" & " | " & Datos_Generales_del_Fondo.t2.Text & " | " & Datos_Generales_del_Fondo.t1.Text
        llenar_grid()
