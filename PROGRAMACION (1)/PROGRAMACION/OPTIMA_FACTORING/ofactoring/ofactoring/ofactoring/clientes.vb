Public Class clientes
    ...
    Public Sub Button8_Click(sender As Object, e As EventArgs) Handles Button8.Click
        ...
        If dr.Read Then
            ...
            cb5.Text = dr(14)
            ComboBox1.Text = dr(15)
            registro_clientes.cod_clie_bdp = dr(0)
            registro_clientes.tipodoc_clie = dr(2)
            registro_clientes.numdoc_clie = dr(3)
            registro_clientes.nom_cliente = dr(8)
            registro_clientes.appat_clie = dr(9)
            registro_clientes.apmat_clie = dr(10)
            registro_clientes.cali_finan = dr(15)
        Else
            MessageBox.Show("El Cliente no Existe")
        End If
